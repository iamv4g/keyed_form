...
|---|---|---|
| [`keyed_lens`](packages/keyed_lens) | [![pub package](https://img.shields.io/pub/v/keyed_lens.svg)](https://pub.dev/packages/keyed_lens) | Composable keyed optics (`Lens`/`AffineLens`/`Prism`/`FieldKey`) — reusable beyond forms |
| [`keyed_form_core`](packages/keyed_form_core) | [![pub package](https://img.shields.io/pub/v/keyed_form_core.svg)](https://pub.dev/packages/keyed_form_core) | Shared form vocabulary: `FieldRef` / `StrictFieldRef` / `VariantRef`, `FieldErrors`, `@keyedSchema` |
| [`keyed_form_schema`](packages/keyed_form_schema) | [![pub package](https://img.shields.io/pub/v/keyed_form_schema.svg)](https://pub.dev/packages/keyed_form_schema) | Declarative schema / validation DSL (`ks.*`); re-exports `keyed_form_core` |
| [`keyed_form_gen`](packages/keyed_form_gen) | [![pub package](https://img.shields.io/pub/v/keyed_form_gen.svg)](https://pub.dev/packages/keyed_form_gen) | `build_runner` codegen: schema → data class + field references + validation |
| [`keyed_form`](packages/keyed_form) | [![pub package](https://img.shields.io/pub/v/keyed_form.svg)](https://pub.dev/packages/keyed_form) | Pure-Dart form controller (`KeyedFormController`) |
| [`keyed_form_flutter`](packages/keyed_form_flutter) | [![pub package](https://img.shields.io/pub/v/keyed_form_flutter.svg)](https://pub.dev/packages/keyed_form_flutter) | Flutter binding (`KeyedForm`, `KeyedFormField`, `KeyedFieldList`) |
