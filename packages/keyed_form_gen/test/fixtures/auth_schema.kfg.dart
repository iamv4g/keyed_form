...
class AuthSchema {
  ...
  /// Static async validator for [AuthSchema].
  static Future<FieldErrors<String>> validateDataAsync(
    AuthSchema schema, [
    FieldKey? scope,
  ]) => schema.validateAsync(scope);

  /// The default `KeyedFormController.scopeOf` for [AuthSchema] — a write inside a
